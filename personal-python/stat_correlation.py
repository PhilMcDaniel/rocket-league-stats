...
all_player_stats = pd.read_csv("d:/Git/MNCS/rocket-league-stats/personal-python/s6_data.csv", sep=',')
...
Prospect_player_stats = all_player_stats[all_player_stats['league_name'] == 'Prospect']
...
Prospect_corrMatrix = Prospect_player_stats.corr()

#print(Premier_corrMatrix)
print(Premier_corrMatrix,Challenger_corrMatrix,RisingStar_corrMatrix,Prospect_corrMatrix)
